...
pub const AI_CONFIG_IMPORT_FBX_CONVERT_TO_M = "IMPORT_FBX_CONVERT_TO_M";
pub const AI_CONFIG_IMPORT_FBX_EMBEDDED_TEXTURES_LEGACY_NAMING = "IMPORT_FBX_EMBEDDED_TEXTURES_LEGACY_NAMING";
...
pub const AI_CONFIG_IMPORT_MDL_COLOR_MAP = "IMPORT_MDL_COLOR_MAP";
...
pub const AI_CONFIG_IMPORT_IFC_CUSTOM_DATA = "IMPORT_IFC_CUSTOM_DATA";
...
pub const AI_CONFIG_IMPORT_OGRE_TEXTURE_TYPE_PREFIX_FROM_FILENAME = "IMPORT_OGRE_TEXTURE_TYPE_PREFIX_FROM_FILENAME";
...
pub const AI_CONFIG_IMPORT_AC_SEPARATE_BACKFACE_CULL = "IMPORT_AC_SEPARATE_BACKFACE_CULL";
...
pub const AI_CONFIG_IMPORT_UNREAL_HANDLE_FLAGS = "IMPORT_UNREAL_HANDLE_FLAGS";
